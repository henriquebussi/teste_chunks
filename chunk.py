...
pdfs = [
    {
        "nome": "Example",
        "caminho": "/content/drive/MyDrive/example.pdf",
        "language": ["eng"],
        "perguntas": [
            "Primeira Pergunta Exemplo",
...
pdfs = [
    ...
    },
    {
        ...
        "language": ["eng"],
        "perguntas": [
            "What is the main objective of this study regarding nitrogen management?", # Fácil
            "Why is nitrate-N leaching considered both an economic loss and an environmental concern?", # Fácil
            "How does water management influence nitrogen uptake efficiency and its transformation in the soil?", # Média
            "List three factors mentioned that affect the biogeochemical transformations of nitrogen in the soil[cite: 1, 3].", # Média
            "Discuss the holistic approach suggested by the authors to minimize non-point source nitrate pollution in groundwater[cite: 1, 11].", # Difícil
            "Analyze how the mineralization process recycles plant and animal litter within the nitrogen cycle according to the text[cite: 3]." # Difícil
        ]
    },
    {
        "nome": "Alva(2006)-Potassium Management",
        "caminho": "/content/drive/MyDrive/SB100/data/Citrus/Alva(2006)-Potassium Managment for Optimizing Citrus...optim - Fernanda Bochi Dos Santos.pdf",
        "language": ["eng"],
        "perguntas": [
            "What are the primary physiological roles of potassium (K) in plants according to the abstract[cite: 1533]?", # Fácil
            "At what leaf concentration threshold do citrus trees typically start showing visible K deficiency symptoms[cite: 1495]?", # Fácil
            "How does high potassium availability affect citrus fruit size and peel characteristics[cite: 1496, 1505]?", # Média
            "Describe the relationship between potassium nutrition and juice acidity levels[cite: 1507].", # Média
            "Explain the mechanism by which high potassium availability in the soil can reduce the uptake of other essential cations[cite: 1508].", # Difícil
            "Discuss the importance of establishing Best Management Practices (BMPs) for K fertilization to ensure sustainable citrus production[cite: 1528, 1530]." # Difícil
        ]
    },
    {
        "nome": "Alva(2008)-Citrus fertig review",
        "caminho": "/content/drive/MyDrive/SB100/data/Citrus/Alva(2008)-Citrus fertig review - Fernanda Bochi Dos Santos.pdf",
        "language": ["eng"],
        "perguntas": [
            "Which two types of micro-irrigation techniques have facilitated the adoption of fertigation in citrus[cite: 1850]?", # Fácil
            "What is one primary benefit of fertigation compared to conventional dry fertilizer broadcasting[cite: 1859]?", # Fácil
            "How does fertigation contribute to minimizing nutrient leaching below the root zone[cite: 1851]?", # Média
            "What specific growth parameter of young citrus trees was significantly increased by fertigation in long-term studies[cite: 1861]?", # Média
            "Evaluate the role of fertigation in improving nutrient uptake efficiency in perennial crops like citrus[cite: 1851].", # Difícil
            "Discuss the impact of long-term fertigation practices on overall crop quality based on the review[cite: 1859, 1861]." # Difícil
        ]
    },
    {
        "nome": "Ameliorating drought stress in sugarcane",
        "caminho": "/content/drive/MyDrive/SB100/data/Citrus/Ameliorating drought stress in sugarcane_bioinsumos.pdf",
        "language": ["eng"],
        "perguntas": [
            "What is the main objective of testing the Sea6 liquid biostimulant formulation LBS6 in sugarcane[cite: 2629]?", # Fácil
            "At what specific days after planting (DAP) was the foliar application of the formulation performed[cite: 2629]?", # Fácil
            "Why is drought stress considered a critical abiotic factor for sugarcane cultivation in India[cite: 2627]?", # Média
            "Which two popular commercial varieties of sugarcane were used to test the efficacy of the biostimulant[cite: 2629]?", # Média
            "Analyze the physiological tools and pheno-phases used in this study to assess drought stress mitigation[cite: 2629].", # Difícil
            "Discuss the potential of seaweed-based biostimulants in containing yield loss due to abiotic stress[cite: 2628]." # Difícil
        ]
    },
    {
        "nome": "Application of biostimulant consortium",
        "caminho": "/content/drive/MyDrive/SB100/data/Citrus/Application of biostimulant consortium_bioinsumos.pdf",
        "language": ["eng"],
        "perguntas": [
            "What was the primary goal of applying the biostimulant consortium to the 'Cenning' variety of sugarcane[cite: 3055]?", # Fácil
            "In what specific land type (dry land vs. wetland) was this study conducted[cite: 3055]?", # Fácil
            "Identify other biostimulant applications (e.g., silica or seaweed) mentioned in the related literature section[cite: 3057, 3058].", # Média
            "How does the study propose that the biostimulant consortium increases the growth of sugarcane in dry land conditions[cite: 3055]?", # Média
            "Critically assess the importance of biostimulants in managing soil resources for sugarcane in water-limited environments[cite: 3055].", # Difícil
            "Compare the research focus of this study with the case study on phosphate solubilizing bacteria mentioned in the document[cite: 3059]." # Difícil
        ]
    },
    {
        ...
        "language": ["eng"],
        "perguntas": [
            "What was the specific dwarfing rootstock used for the Tahiti acid lime in this high-density planting study[cite: 4586]?", # Fácil
            "Which intercrop species was maintained as mulch in the no-tillage systems evaluated[cite: 4587, 4591]?", # Fácil
            "Compare the effect of the no-tillage (NT) system and conventional tillage (CT) on potassium (K) concentrations in the leaves[cite: 4590].", # Média
            "How did the maintenance of Urochloa ruziziensis mulch influence undesirable weed populations[cite: 4589]?", # Média
            "Evaluate the benefits of high-density planting (1,157 trees/ha) combined with no-tillage for sustainable citrus production[cite: 4585, 4586].", # Difícil
            "Discuss how soil physical and chemical characteristics were influenced by the different tillage systems over the 5-year study period[cite: 4587, 4588]." # Difícil
        ]
    }
    # Adicione mais PDFs aqui seguindo o mesmo padrão
]
